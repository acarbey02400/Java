...
import kodlamaio.hrms.business.abstracts.SystemEmployeeConfirmService;
...
public class SystemEmployeeConfirmController {
	...
	public Result confirm(@RequestBody SystemEmployeeConfirmEmployer systemEmployeeConfirmEmployer) {
		return this.systemEmployeeConfirmEmployerService.employerConfirm(systemEmployeeConfirmEmployer);
	}
}
